...
class EnableMfaProfileRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("EnableMFA",$param) and $param["EnableMFA"] !== null) {
            if(is_bool($param["EnableMFA"])){
                $this->RequestParams["EnableMFA"] = $param["EnableMFA"] ? "true" : "false";
            } else {
                $this->RequestParams["EnableMFA"] = $param["EnableMFA"];
            }
        }
